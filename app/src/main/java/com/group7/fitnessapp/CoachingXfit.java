...
public class CoachingXfit extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.coach_profile_xfit);
    }

    public void onSend(View view) {
        final AlertDialog.Builder alert = new AlertDialog.Builder(CoachingXfit.this);
