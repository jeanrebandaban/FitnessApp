...
public class CoachingFitness extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.coach_profile_fitness);
    }


    public void onSend(View view) {
        final AlertDialog.Builder alert = new AlertDialog.Builder(CoachingFitness.this);
