...
public class CoachingAthletic extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.coach_profile_athletic);
    }

    public void onSend(View view) {
        final AlertDialog.Builder alert = new AlertDialog.Builder(CoachingAthletic.this);
