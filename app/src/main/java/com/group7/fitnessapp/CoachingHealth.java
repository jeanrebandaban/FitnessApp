...
public class CoachingHealth extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.coach_profile_health);
    }

    public void onSend(View view) {
        final AlertDialog.Builder alert = new AlertDialog.Builder(CoachingHealth.this);
